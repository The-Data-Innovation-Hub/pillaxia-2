...
CREATE INDEX idx_engagement_scores_user_date ON public.patient_engagement_scores(user_id, score_date DESC);
CREATE INDEX idx_engagement_scores_risk ON public.patient_engagement_scores(risk_level, score_date DESC);
CREATE INDEX idx_activity_log_user ON public.patient_activity_log(user_id, created_at DESC);
CREATE INDEX idx_activity_log_type ON public.patient_activity_log(activity_type, created_at DESC);
