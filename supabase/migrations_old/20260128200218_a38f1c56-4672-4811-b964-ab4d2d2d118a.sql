...
CREATE INDEX IF NOT EXISTS idx_medications_prescription_status 
...
CREATE INDEX IF NOT EXISTS idx_prescriptions_clinician 
...
CREATE INDEX IF NOT EXISTS idx_notification_history_retry_queue 
...
CREATE INDEX IF NOT EXISTS idx_data_access_log_patient 
...
CREATE INDEX IF NOT EXISTS idx_symptom_entries_type 
ON public.symptom_entries (symptom_type);

-- Lab results: user lookup with ordering
CREATE INDEX IF NOT EXISTS idx_lab_results_user_ordered 
...
CREATE INDEX IF NOT EXISTS idx_clinician_patient_clinician 
ON public.clinician_patient_assignments (clinician_user_id);

CREATE INDEX IF NOT EXISTS idx_clinician_patient_patient 
ON public.clinician_patient_assignments (patient_user_id);

-- Clinician messages: conversation lookup
CREATE INDEX IF NOT EXISTS idx_clinician_messages_patient_created 
ON public.clinician_messages (patient_user_id, created_at DESC);

CREATE INDEX IF NOT EXISTS idx_clinician_messages_clinician_created 
ON public.clinician_messages (clinician_user_id, created_at DESC);

-- Caregiver invitations: status filtering
CREATE INDEX IF NOT EXISTS idx_caregiver_invitations_patient_status 
...
CREATE INDEX IF NOT EXISTS idx_refill_requests_status 
ON public.refill_requests (status) WHERE status IN ('pending', 'approved');

-- Controlled drugs: low stock alerts
CREATE INDEX IF NOT EXISTS idx_controlled_drugs_stock_alert 
...
CREATE INDEX IF NOT EXISTS idx_polypharmacy_warnings_unacked 
...
CREATE INDEX IF NOT EXISTS idx_medication_logs_schedule_med 
ON public.medication_logs (schedule_id, medication_id);

-- Video rooms: appointment lookup
CREATE INDEX IF NOT EXISTS idx_video_rooms_created 
