...
CREATE INDEX IF NOT EXISTS idx_medications_user_prescriber 
...
CREATE INDEX IF NOT EXISTS idx_controlled_drug_dispensing_patient_user_id 
  ON public.controlled_drug_dispensing(patient_user_id);
CREATE INDEX IF NOT EXISTS idx_controlled_drug_dispensing_prescriber_user_id 
  ON public.controlled_drug_dispensing(prescriber_user_id);
CREATE INDEX IF NOT EXISTS idx_controlled_drug_dispensing_prescription_id 
  ON public.controlled_drug_dispensing(prescription_id);

-- Composite index for patient + prescriber queries
CREATE INDEX IF NOT EXISTS idx_controlled_drug_dispensing_patient_prescriber 
...
CREATE INDEX IF NOT EXISTS idx_controlled_drug_dispensing_dispensed_at 
...
CREATE INDEX IF NOT EXISTS idx_drug_transfers_source_status 
  ON public.drug_transfers(source_pharmacy_id, status);
CREATE INDEX IF NOT EXISTS idx_drug_transfers_destination_status 
...
CREATE INDEX IF NOT EXISTS idx_organization_invoices_org_id 
  ON public.organization_invoices(organization_id);

-- Index for date-based queries
CREATE INDEX IF NOT EXISTS idx_organization_invoices_due_date 
...
CREATE INDEX IF NOT EXISTS idx_patient_vitals_user_recorded 
...
CREATE INDEX IF NOT EXISTS idx_prescriptions_clinician_date 
