...
CREATE INDEX idx_refill_requests_status ON public.refill_requests(status);
CREATE INDEX idx_refill_requests_patient ON public.refill_requests(patient_user_id);
CREATE INDEX idx_refill_requests_medication ON public.refill_requests(medication_id);
