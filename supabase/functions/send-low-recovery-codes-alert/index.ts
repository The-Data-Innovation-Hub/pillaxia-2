...
const requestSchema = {
  ...
  firstName: validators.optional(validators.string({ maxLength: 100 })),
  remainingCodes: validators.number({ min: 0, max: 20, integer: true }),
};
...
serve(withSentry("send-low-recovery-codes-alert", async (req: Request): Promise<Response> => {
    ...
    html: `
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #fff; padding: 30px; border: 1px solid #e2e8f0; border-top: none;">
          ...
          <p style="margin: 0 0 15px 0;">Hi ${escapedName},</p>
