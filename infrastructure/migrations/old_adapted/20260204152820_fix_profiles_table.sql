...
-- Remove email column (duplicates public.users.email)
...
COMMENT ON TABLE public.profiles IS 
  'User profiles. Email is available via public.users.email join. Organization via organization_id FK. Part of 3NF compliance.';
