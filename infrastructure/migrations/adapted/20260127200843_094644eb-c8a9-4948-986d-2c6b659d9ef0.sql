...
CREATE INDEX idx_pharmacy_locations_state ON public.pharmacy_locations(state);
CREATE INDEX idx_pharmacy_locations_city ON public.pharmacy_locations(city);
CREATE INDEX idx_medication_availability_name ON public.medication_availability(medication_name);
CREATE INDEX idx_medication_availability_pharmacy ON public.medication_availability(pharmacy_id);
CREATE INDEX idx_patient_preferred_pharmacies_patient ON public.patient_preferred_pharmacies(patient_user_id);
CREATE INDEX idx_medication_alerts_patient ON public.medication_availability_alerts(patient_user_id);
CREATE INDEX idx_medication_alerts_name ON public.medication_availability_alerts(medication_name);
