  ...
  const handleStartTotpEnroll = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: errorMessage || "Could not start enrollment. Please try again.",
        variant: "destructive",
      });
    } finally {
      setEnrolling(false);
  ...
  const handleStartPhoneEnroll = async () => {
    ...
    try {
      ...
      const message = error instanceof Error
        ? error.message
        : "Could not send verification code. Please check your phone number.";
      toast({
  ...
  const handleDisable2FA = async (factor: MFAFactor) => {
    ...
    try {
      ...
      toast({
        ...
        description: (error as Error).message || "Invalid code or error occurred.",
        variant: "destructive",
      });
    } finally {
      setDisabling(false);
  ...
  const handleRegenerateRecoveryCodes = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: (error as Error).message || "Invalid verification code.",
        variant: "destructive",
      });
    } finally {
  ...
  const handleSuspend2FA = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: message || "Invalid recovery code or error occurred.",
        variant: "destructive",
      });
    } finally {
      setSuspending(false);
